...
INSERT INTO "new_Clinic" ("createdAt", "id", "name", "timezone", "whatsappPhone", "workDays", "workEndHour", "workStartHour") SELECT "createdAt", "id", "name", "timezone", "whatsappPhone", "workDays", "workEndHour", "workStartHour" FROM "Clinic";
DROP TABLE "Clinic";
