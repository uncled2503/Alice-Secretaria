...
const FAQS: { question: string; alternates: string; answer: string }[] = [
  ...
  {
    question: "Vocês fazem peças com o nome do bebê bordado?",
    alternates:
      "personalizado\npersonalizados\npersonalização\npersonalizar\nnome bordado\nbordar o nome\nbordar o nome do bebê\ncom o nome\ncom o nome do bebê\nnome completo\nmonograma\nbordado\nsob encomenda\nnaninha com o nome\nmanta com o nome\npelúcia com o nome\nquero uma peça com o nome",
    answer:
      "A Laleblu não trabalha com personalização sob encomenda, então não bordamos o nome do bebê nas peças 🤍 O que temos são itens já prontos com a inicial (uma letra) do bebê:\n• Todos os personalizados: https://laleblu.com.br/collections/personalizados\n• Fralda de boca e ombro com inicial: https://laleblu.com.br/collections/fralda-de-boca-e-ombro-personalizada\n• Touca com inicial: https://laleblu.com.br/collections/touca-para-bebe-personalizada\n• Faixa de cabelo com inicial: https://laleblu.com.br/collections/faixa-de-cabelo-para-bebe-personalizada\nNaninha, manta e pelúcia não têm versão com nome nem com inicial.",
  },
  {
...
const RULES: { category: string; instruction: string }[] = [
  ...
  { category: "procedimentos", instruction: "A Laleblu NÃO trabalha com personalização sob encomenda e NÃO borda o nome do bebê em nenhuma peça. Quando pedirem algo 'com o nome do bebê', 'personalizado', 'bordado' ou 'sob encomenda' (inclusive naninha, manta ou pelúcia com o nome), diga com clareza que não fazemos isso. O que existe são itens JÁ PRONTOS com a inicial (uma letra) do bebê — fralda de boca e ombro, touca e faixa de cabelo; mande o link da coleção de personalizados: https://laleblu.com.br/collections/personalizados. Nunca afirme que uma peça pode vir com o nome bordado." },
  // chamar a equipe
