...
const FAQS: { question: string; alternates: string; answer: string }[] = [
  ...
  },
  {
    ...
    alternates: "frete\nentrega\nprazo\nmotoboy\nmesmo dia\ncorreios\nchega quando\nquanto tempo\nfrete grátis",
    answer:
      "Frete grátis para compras com preço regular:\n• Cidade de SP: a partir de R$ 399 • Estado de SP: a partir de R$ 599 • Sul, Sudeste e Centro-Oeste: a partir de R$ 699 • Norte e Nordeste: a partir de R$ 799\nO prazo e o valor aparecem no carrinho quando você coloca o CEP. Entrega expressa em São Paulo e região: R$ 29,90, chega no próximo dia útil até as 22h.\nRegras completas: https://laleblu.com.br/policies/shipping-policy",
  },
  {
  ...
  {
    question: "Onde posso comprar? A compra é só pelo site?",
    alternates:
      "onde compro\nonde comprar\nonde posso comprar\ncomo compro\ncomo faço pra comprar\na compra é só pelo site\ncompra é somente pelo site\nsó pelo site\nsó vende pelo site\ntem que ser pelo site\ncompro pelo site\nvende na loja\ncomprar na loja\ncomprar pessoalmente\nposso comprar na loja física\nvocês vendem na loja",
    answer:
      "Você compra do jeito que preferir 💙\n• No site, com entrega para todo o Brasil: https://laleblu.com.br\n• Pessoalmente, nas nossas lojas físicas em São Paulo: Moema (Av. Bem-te-vi, 177), Shopping Cidade Jardim (3º piso), Shops Jardins (Rua Haddock Lobo, 1626) e o quiosque da Riviera de São Lourenço, em Bertioga\nHorários e mapa de cada loja: https://laleblu.com.br/pages/nossas-lojas",
  },
  {
  ...
  {
    question: "Vocês fazem peças com o nome do bebê bordado? Personalizado?",
    alternates:
      "personalizado\npersonalizados\npersonalização\npersonalizar\nnome bordado\nbordar o nome\nbordar o nome do bebê\nopção de bordar\ncom o nome\ncom o nome do bebê\nnome completo\nmonograma\nbordado\nsob encomenda\nprazo para bordar\nnaninha com o nome\nmanta com o nome\npelúcia com o nome\nbordar na naninha\nbordar na manta\nquero uma peça com o nome",
    answer:
      "A Laleblu não personaliza peças nem borda o nome do bebê — não fazemos nada sob encomenda 🤍 O único item com bordado são as fraldas de boca e ombro, que já vêm com a inicial (uma letra) bordada, pronta entrega: https://laleblu.com.br/collections/fralda-de-boca-e-ombro-personalizada\nNenhuma outra peça (naninha, manta, pelúcia, roupa) tem versão com nome nem com inicial.",
  },
  {
...
const PLAYBOOKS: {
  ...
  },
  {
    ...
    steps: [
      ...
      "NUNCA mande link de produto individual (/products/) nem chute o slug de uma peça: você não tem a lista de produtos. O resultado é sempre a coleção filtrada — a cliente abre e escolhe a peça lá dentro.",
...
const RULES: { category: string; instruction: string }[] = [
  ...
  { category: "procedimentos", instruction: "A Laleblu vende pelo site (com entrega pro Brasil todo) E nas 4 lojas físicas (Moema, Shopping Cidade Jardim, Shops Jardins e o quiosque da Riviera de São Lourenço, em Bertioga). NUNCA diga que a compra é 'só pelo site' ou 'apenas pelo site': quem quiser comprar pessoalmente é bem-vindo nas lojas. O site é a referência de preço e estoque em tempo real; a loja física confirma peça e disponibilidade pelo WhatsApp da unidade." },
  ...
  { category: "procedimentos", instruction: "Entrega expressa (São Paulo e região) custa R$ 29,90 e chega no próximo dia útil, até as 22h. NUNCA diga que essa entrega é 'no mesmo dia' nem chame de 'motoboy no mesmo dia' - é sempre no dia útil seguinte. O valor e o prazo do frete aparecem no carrinho quando a cliente coloca o CEP." },
  { category: "procedimentos", instruction: "Entrega no mesmo dia é um benefício exclusivo do Clube VIP, sem preço nem prazo cadastrados aqui - NUNCA informe R$ 29,90 (nem qualquer outro valor) pra entrega no mesmo dia, isso é da entrega expressa comum. Se a cliente perguntar por entrega mais rápida que o dia seguinte, diga que isso é um diferencial de quem é do Clube VIP e convide a conhecer: https://laleblu.com.br/pages/clube-vip." },
  ...
  { category: "procedimentos", instruction: "A Alice NÃO tem a lista de produtos e NÃO conhece o endereço nem o nome exato de nenhuma peça: é PROIBIDO montar, chutar ou deduzir um link de produto (/products/...) — sempre gera link quebrado. O único /products/ que pode ser enviado é a embalagem de presente, exatamente como está escrita na FAQ. Para qualquer outra peça, o link é sempre de COLEÇÃO (/collections/...) ou de página (/pages/...), e só os que estão escritos nas FAQ e nos roteiros. Se a cliente quer uma peça específica (ex: 'macacão de algodão pima para menina'), mande a coleção filtrada — ex: https://laleblu.com.br/collections/macacoes-algodao-pima?filter.p.m.custom.genero=Menina — e diga que é só abrir e escolher. Nunca escreva o nome de um produto como se fosse um link, nunca liste 'produtos' com links." },
  ...
  { category: "procedimentos", instruction: "A Laleblu NÃO personaliza nada e NÃO faz nada sob encomenda. O ÚNICO produto com bordado são as fraldas de boca e ombro, que já vêm de fábrica com a INICIAL (uma letra) do bebê, pronta entrega — link: https://laleblu.com.br/collections/fralda-de-boca-e-ombro-personalizada. Qualquer outro pedido de 'bordar o nome', 'com o nome do bebê', 'personalizado' ou 'opção de bordar' (naninha, manta, pelúcia, roupa, touca, o que for): diga com clareza que não fazemos. NUNCA ofereça 'opção de bordar', NUNCA fale em 'prazo para bordar' nem em 'prazo de produção de peça personalizada' — isso não existe na Laleblu." },
  // chamar a equipe
